...
// biome-ignore lint/nursery/noProcessEnv: this concept3d functions only need to be executed once, so don't really expect it to always be present, which is why i'm omitting it from typed envs
