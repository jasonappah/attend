...
const palettes = {
    ...
    ,
      "dark": ['hsla(50, 100%, 59%, 1)','hsla(41, 100%, 15%, 0)','hsla(41, 100%, 15%, 0.25)','hsla(41, 100%, 15%, 0.5)','hsla(41, 100%, 15%, 0.75)','hsla(41, 100%, 15%, 1)','hsla(41, 100%, 19%, 1)','hsla(41, 100%, 23%, 1)','hsla(41, 100%, 27%, 1)','hsla(41, 100%, 31%, 1)','hsla(41, 100%, 34%, 1)','hsla(41, 100%, 38%, 1)','hsla(41, 100%, 42%, 1)','hsla(41, 100%, 46%, 1)','hsla(41, 100%, 50%, 1)','hsla(0, 15%, 93%, 1)','hsla(0, 15%, 95%, 1)','hsla(0, 15%, 95%, 0.75)','hsla(0, 15%, 95%, 0.5)','hsla(0, 15%, 95%, 0.25)','hsla(0, 15%, 95%, 0)','hsla(50, 100%, 55%, 1)']
    ,
      "light_accent": ['hsla(41, 100%, 73%, 1)','hsla(50, 100%, 40%, 0)','hsla(50, 100%, 40%, 0.25)','hsla(50, 100%, 40%, 0.5)','hsla(50, 100%, 40%, 0.75)','hsla(50, 100%, 40%, 1)','hsla(50, 100%, 43%, 1)','hsla(50, 100%, 46%, 1)','hsla(50, 100%, 48%, 1)','hsla(50, 100%, 51%, 1)','hsla(50, 100%, 54%, 1)','hsla(50, 100%, 57%, 1)','hsla(50, 100%, 59%, 1)','hsla(50, 100%, 62%, 1)','hsla(50, 100%, 65%, 1)','hsla(250, 50%, 95%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(41, 100%, 54%, 1)']
    ,
      "dark_accent": ['hsla(41, 100%, 46%, 1)','hsla(50, 100%, 52%, 0)','hsla(50, 100%, 52%, 0.25)','hsla(50, 100%, 52%, 0.5)','hsla(50, 100%, 52%, 0.75)','hsla(50, 100%, 52%, 1)','hsla(50, 100%, 53%, 1)','hsla(50, 100%, 54%, 1)','hsla(50, 100%, 55%, 1)','hsla(50, 100%, 56%, 1)','hsla(50, 100%, 56%, 1)','hsla(50, 100%, 57%, 1)','hsla(50, 100%, 58%, 1)','hsla(50, 100%, 59%, 1)','hsla(50, 100%, 60%, 1)','hsla(250, 50%, 90%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(41, 100%, 27%, 1)']
